...
if [ ! -d "$INSTALL_DIR" ]; then
    ...
    wget https://raw.githubusercontent.com/flys345/VPS-MX_8.1_SIN_KEY_MOD_FYSANDROID/master/Zzupdate-master/zzupdate.sh -O /usr/local/vpsmxup/vpsmxup.sh &> /dev/null
