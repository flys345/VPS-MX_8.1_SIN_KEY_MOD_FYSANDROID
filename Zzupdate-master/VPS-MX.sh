...
kalix1="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2ZseXMzNDUvVlBTLU1YXzguMV9TSU5fS0VZX01PRF9GWVNBTkRST0lEL21hc3Rlci9TQ1JJUFQ="
PUTO='base64 -d'
...
echo 'echo "" '>> .bashrc
echo 'echo -e "	\e[1;43mMOD GRATIS -🔰FLYSANDROIDPERU\e[0m"'>> .bashrc
...
msg -bar2
echo -e "	\e[1;43m MOD VPS-MX  > Creditos: @Flys_Android\e[0m"
msg -bar2
...
Key="🔰MOD BY FLYS ANDROID PERU' SIN MINERIA🔰."
